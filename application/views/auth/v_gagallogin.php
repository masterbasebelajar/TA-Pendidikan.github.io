                            ...
                            <div class="col-lg">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-2"><?= $peringatan; ?></h1>
                                        <p class="mb-4">Silahkan masukan Username dan Password yang benar. Jika anda belum terdaftar silahkan Registrasi terlebih dahulu!</p>
                                    </div>
